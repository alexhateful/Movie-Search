...
class App extends React.Component {
  ...
  showMoreSearch = () => {
    ...
    .then(data => {
      ...
      this.setState({ movies: moreItems, currentPage: this.state.currentPage+1, moviesLength: this.state.movies.length })
    })
  }
  ...
  getTopMovies = () => {
    fetch(`https://api.themoviedb.org/3/discover/movie?api_key=${this.apiKey}&language=en-US&sort_by=vote_average.desc&vote_count.gte=2000&include_adult=false&include_video=false&page=1&vote_average.gte=${this.state.valRatingFrom}&vote_average.lte=${this.state.valRatingTo}&primary_release_date.gte=${this.state.valYearFrom}&primary_release_date.lte=${this.state.valYearTo}`)
    .then(data => data.json())
    .then(data => {
      this.setState({ movies: [...data.results],
        totalResults: data.total_results,
  ...
  showMoreTopMovies = () => {
    fetch(`https://api.themoviedb.org/3/discover/movie?api_key=${this.apiKey}&language=en-US&sort_by=vote_average.desc&vote_count.gte=1000&include_adult=false&include_video=false&page=1&vote_average.gte=${this.state.valRatingFrom}&vote_average.lte=${this.state.valRatingTo}&primary_release_date.gte=${this.state.valYearFrom}&primary_release_date.lte=${this.state.valYearTo}&page=${this.state.currentPage+1}`)
    .then(data => data.json())
    .then(data => {
      let moreItems = this.state.movies.concat([...data.results])
      this.setState({ movies: moreItems, currentPage: this.state.currentPage+1, moviesLength: this.state.movies.length })
  ...
  getTopTvShows = () => {
    ...
    fetch(`https://api.themoviedb.org/3/discover/tv?api_key=${this.apiKey}&language=en-US&sort_by=vote_average.desc&first_air_date.gte=${this.state.valYearFrom}&first_air_date.lte=${this.state.valYearTo}&page=1&timezone=America%2FNew_York&vote_average.gte=${this.state.valRatingFrom}&vote_average.lte=${this.state.valRatingTo}&vote_count.gte=100&include_null_first_air_dates=false`)
    .then(data => data.json())
    .then(data => {
      this.setState({ movies: [...data.results],
        totalResults: data.total_results,
  ...
  showMoreTopTv = () => {
    fetch(`https://api.themoviedb.org/3/discover/tv?api_key=${this.apiKey}&language=en-US&sort_by=vote_average.desc&first_air_date.gte=${this.state.valYearFrom}&first_air_date.lte=${this.state.valYearTo}&page=${this.state.currentPage+1}&timezone=America%2FNew_York&vote_average.gte=${this.state.valRatingFrom}&vote_average.lte=${this.state.valRatingTo}&vote_count.gte=100&include_null_first_air_dates=false`)
    .then(data => data.json())
    .then(data => {
      let moreItems = this.state.movies.concat([...data.results]);
      this.setState({ movies: moreItems, currentPage: this.state.currentPage+1, moviesLength: this.state.movies.length })
  ...
  getGenre = (e) => {    
    ...
    fetch(`https://api.themoviedb.org/3/discover/movie?api_key=${this.apiKey}&language=en-US&sort_by=vote_average.desc&include_adult=false&include_video=false&page=1&vote_count.gte=500&vote_average.gte=${this.state.valRatingFrom}&vote_average.lte=${this.state.valRatingTo}&primary_release_date.gte=${this.state.valYearFrom}&primary_release_date.lte=${this.state.valYearTo}&with_genres=${this.state.genreId}`)
    .then(data => data.json())
    .then(data => {
      this.setState({ movies: [...data.results],
        totalResults: data.total_results,
  ...
  showMoreGenre = () => {
    fetch(`https://api.themoviedb.org/3/discover/movie?api_key=${this.apiKey}&language=en-US&sort_by=vote_average.desc&include_adult=false&include_video=false&page=1&vote_count.gte=500&vote_average.gte=${this.state.valRatingFrom}&vote_average.lte=${this.state.valRatingTo}&primary_release_date.gte=${this.state.valYearFrom}&primary_release_date.lte=${this.state.valYearTo}&with_genres=${this.state.genreId}&page=${this.state.currentPage+1}`)
    .then(data => data.json())
    .then(data => {
      let moreItems = this.state.movies.concat([...data.results]);
      this.setState({ movies: moreItems, currentPage: this.state.currentPage+1, moviesLength: this.state.movies.length })
...
{/* <div className="col l3">
<Menu search={this.state.search} trendTv={this.state.trendTv} trendMovie={this.state.trendMovie} valRatingFrom={this.state.valRatingFrom} valRatingTo={this.state.valRatingTo} valYearFrom={this.state.valYearFrom} valYearTo={this.state.valYearTo} filterRatingOn={this.filterRatingOn} filterYearOn={this.filterYearOn} getGenre={this.getGenre} />
</div> */}